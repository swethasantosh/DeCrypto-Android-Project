...
public class Currency_Adapter extends RecyclerView.Adapter<Currency_Adapter.ViewHolder_Currency>
{
...
//    SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
    ...
    public Currency_Adapter(Context context,ArrayList<Currency> arrayList)
    {
        this.currencylist = arrayList;
    }

    //constructor
    public Currency_Adapter(Context context)
    {
